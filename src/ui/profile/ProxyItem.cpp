...
void ProxyItem::refresh_data() {
    ...
    ui->traffic->setText(QStringLiteral("%1↑ %2↓")
                         .arg(ent->DisplayTrafficTx(), ent->DisplayTrafficRx()));
    ui->test_result->setText(QStringLiteral("%1 | Rx %2 | Conn %3 | Score %4")
                             .arg(ent->DisplayLatency(), ent->DisplayRxSpeed(),
                                  ent->DisplayConnectionTime(), ent->DisplaySiteScore()));
