...
function(spb_enable_warnings TARGET)
  if(MSVC)
    if(CMAKE_CXX_COMPILER_ID STREQUAL "Clang")
      ...
      target_compile_options(${TARGET} PRIVATE /W4 /wd4996 /wd4244 /EHs -Wno-missing-field-initializers)
    else()
      # https://developercommunity.visualstudio.com/t/c2017-illegal-escape-sequence-when-using-in-a-raw/919371
      target_compile_options(${TARGET} PRIVATE /W4 /wd4996 /wd4244 /Zc:preprocessor)
    endif()        
